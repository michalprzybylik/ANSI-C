/*
Ćwiczenie 4.7. Napisz funkcję ungets(s), która będzie oddawać na wejście cały 
tekst z argumentu s. Czy funkcja ta powinna coś wiedzieć o obiektach buf 
i bufp, czy też po prostu można w niej skorzystać z funkcji ungetch?
*/
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
