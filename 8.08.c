/* 
Ćwiczenie 8.8. Napisz podprogram bfree(p, n), który dowolny n-znakowy blok pamięci 
o adresie p dołącza do łańcucha wolnych bloków obsługiwanych przez 
funkcje malloc i free. Dzięki bfree użytkownik będzie mógł w każdej chwili 
dołączyć do tego łańcucha tablice statyczne lub zewnętrzne.
*/
#include <unistd.h>
#include <stdio.h>
