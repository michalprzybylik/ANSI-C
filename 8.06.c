/* 
Ćwiczenie 8.6. Funkcja calloc(n, size) z biblioteki standardowej zwraca wskaźnik 
do n obiektów o rozmiarze size, których pamięć została zapełniona zerami. 
Napisz funkcję calloc, korzystając z wywołań malloc lub traktując tę funkcję 
jako wzorzec. 
*/
#include <unistd.h>
#include <stdio.h>
