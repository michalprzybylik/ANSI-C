/*
Ćwiczenie 4.9. Nasze funkcje getch i ungetch nie obsługują poprawnie znacznika 
końca pliku EOF. Określ, jakie własności powinny mieć te funkcje, żeby 
EOF mógł być oddawany, a następnie zrealizuj swój projekt.
*/
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
